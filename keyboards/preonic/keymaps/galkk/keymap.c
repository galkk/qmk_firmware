...
[0] = LAYOUT_ortho_5x12(
	...
	CAPS_WORD, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, LCA_T(KC_SLSH), RSA(KC_NO),
	KC_NO, KC_LALT, KC_LCTL, MO(2), KC_LSFT, KC_BSPC, KC_ENT, KC_SPC, MO(1), KC_LBRC, KC_RBRC, KC_NO),
...
[1] = LAYOUT_ortho_5x12(
	...
	KC_NO, KC_NO, KC_NO, KC_INS, KC_DEL, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_LPRN, KC_RPRN, KC_NO),
...
[2] = LAYOUT_ortho_5x12(
	...
	KC_CAPS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO, KC_NO,
